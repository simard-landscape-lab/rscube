...
#
#       python ./download-all-2020-09-22_18-40-57.py
#
#    Download all files in a Metalink/CSV: (downloaded from ASF Vertex)
#
#       python ./download-all-2020-09-22_18-40-57.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
#
...
class bulk_downloader:
    def __init__(self):
        ...
        self.files = [ "https://datapool.asf.alaska.edu/RTC_HI_RES/A3/AP_27644_PLR_F0580_RT1.zip" ]
